      ...
      <View style={{alignItems:"center"}}>
        <Form ref="form">
          <View style={styles.inputRow}>
            <TextInput type="TextInput" name="username" returnKeyType = {"next"} autoCapitalize="none" autoCorrect={false} placeholderTextColor="#777" style={styles.input} placeholder="用户名"/>
